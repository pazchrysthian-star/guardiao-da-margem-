...
import { ShareMercadoSelector } from "@/components/margem/ShareMercadoSelector"
...
import { T3MShareGainLossSelector } from "@/components/margem/T3MShareGainLossSelector"
        ...
        <main className="px-4 pb-24 pt-4 sm:px-6 sm:pb-12 lg:px-9">
          ...
          {!d.result ? (
            ...
            <>
              ...
              <section className="section-shell"><div className="section-heading"><div><span>04</span><h2>Share e evolução vs mercado</h2></div><p>Participação de mercado com opções de período (MAT, YoY, Trimestral) e análise de regras.</p></div><ShareMercadoSelector fonte={fonteMercado} /><EvolucaoAcumuladaSelector fonte={fonteMercado} /><RegrasShareMercado fonte={fonteMercado} /><T3MShareGainLossSelector fonte={fonteMercado} /></section>
